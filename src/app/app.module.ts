...
@NgModule({
  ...
  imports: [BrowserModule, HttpClientModule, AlunoDetalhesModule, AlunoListModule, ProfessorListModule, ProfessorDetalhesModule, IonicModule.forRoot(), AppRoutingModule],
